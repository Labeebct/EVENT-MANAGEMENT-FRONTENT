const HomeCatFrame = ({ list , from }) => {
  return (
    <>
        <div
          className={`w-[20%] duration-200 ease-in-out ${from == 'home' && 'hover:-translate-y-2'} bg-white mx-auto flex justify-center flex-col shadow-box my-5 rounded-[.3rem] min-w-[300px] h-auto p-4`}
          key={list.id}
        >
          <img
            src={`http://localhost:8082/${list.categoryImage}`}
