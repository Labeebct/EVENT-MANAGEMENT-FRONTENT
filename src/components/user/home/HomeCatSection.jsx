  ...
  const catObj = [
    {
      ...
      title: "party",
      description:
        "Party planning is the art of organizing social events, handling details like venue, decorations, food, and entertainment to ensure a great time for guests",
    },
    {
      id: 2,
      image: cateringImg,
      title: "catering",
      description:
        "Catering involves preparing and serving food and drinks for events. Caterers manage menu, and service to ensure guests enjoy delicious meals tailored to the occasion.",
    },
    {
      id: 3,
      image: weddingImg,
      title: "wedding",
      description:
        "Wedding planning includes organizing ceremonies, coordinating venues, decor, food, and entertainment to create memorable experiences for guests.",
    },
    {
      id: 4,
      image: conferenceImg,
      title: "conference",
      description:
        "Conference management involves planning events, arranging venues, speakers, logistics, and materials to ensure informative and engaging experiences for attendees.",
    },
  ];
